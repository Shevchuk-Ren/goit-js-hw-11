...
class Timer {
  ...
  convertMs(ms) {
    ...
    const days = this.pad(Math.floor(ms / day)); // Remaining hours

    const hours = this.pad(Math.floor(ms % day / hour)); // Remaining minutes

    const minutes = this.pad(Math.floor(ms % day % hour / minute)); // Remaining seconds
